...
func TestStackTraces(t *testing.T) {
	tests := []struct {
		...
		/*
			...
			from /Users/stanlow/projects/go/src/github.com/tetrafolium/goby/vm/error_test.go:9
			from /Users/stanlow/projects/go/src/github.com/tetrafolium/goby/vm/error_test.go:2
			from /Users/stanlow/projects/go/src/github.com/tetrafolium/goby/vm/error_test.go:8
